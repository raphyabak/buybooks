<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between" x-data="{newCategory:false}">
        <h3 class="text-3xl font-bold text-gray-700">Categories</h3>
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true"
            x-show="newCategory" x-cloak>
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div @click="newCategory = ! newCategory"
                        ...
                        @forelse ($categories as $category)
                            <tr>
                                ...
                                <td
                                    ...
                                    <span x-data="{editCategory:false}">
                                        <button @click="editCategory = true" class="px-4"><svg
                                        ...
                                        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title"
                                            role="dialog" aria-modal="true" x-show="editCategory" x-cloak>
                                            <div
                                                class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                                <div @click="editCategory = ! editCategory"
                                    ...
                                    <span x-data="{deleteCategory:false}" @click.away="deleteCategory = false"
                                        @close.stop="deleteCategory = false"
                                        @category-deleted.window="deleteCategory = false">
                                            <button @click="deleteCategory = true" class="px-4"><svg
                                            ...
                                            <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title"
                                                role="dialog" aria-modal="true" x-show="deleteCategory" x-cloak>
                                                <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0"
                                                    x-cloak>
                                                    <div
                                                        ...
                                                        <div class="w-full h-full text-center">
                                                            <div class="flex flex-col justify-between h-full">
                                                                ...
                                                                <p
                                                                    ...
                                                                    delete this category {{ $category->id }}?</p>
                                                                <div
