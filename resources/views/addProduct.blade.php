    ...
    <form wire:submit.prevent='addProduct'>
        <div class="overflow-hidden shadow sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
                ...
                <div class="grid grid-cols-6 gap-6 pt-4">
                    ...
                    {{-- <div class="col-span-12 sm:col-span-6">
                        <label for="category" class="block text-sm font-medium text-gray-700">Course Advisor</label>
                        <select id="adviser" name="adviser" wire:model='category'
        ...
        <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
            <button type="submit"
                ...
                Save <svg wire:loading wire:target="addProduct" class="w-5 h-5 text-white animate-spin"
            ...
            <button @click="newProduct = false" type="button"
